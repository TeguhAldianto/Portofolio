    ...
    <div class="container grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div class="lg:col-span-7 order-2 lg:order-1" data-aos="fade-up" data-aos-duration="800">
            ...
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-tight">
                ...
                <span class="text-3xl md:text-4xl lg:text-5xl text-zinc-500 dark:text-zinc-400 font-semibold">Architecting scalable web and mobile solutions.</span>
            </h1>

            <p class="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 mb-10 max-w-2xl leading-relaxed reveal-text">
                Saya <strong class="text-zinc-900 dark:text-white">Teguh Aldianto</strong>. Fokus membangun aplikasi skalabel menggunakan Laravel, Vue, dan Kotlin dengan penerapan MVVM & Clean Architecture.
            </p>
