<header id="navbar" class="fixed top-6 inset-x-0 z-50 flex justify-center px-4 transition-all duration-500">
    <div class="glass-card rounded-full px-4 py-2 flex items-center gap-6 md:gap-8 transition-all duration-500">
